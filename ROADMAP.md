...
- [x] [WP-0.5](docs/work-packages/WP-0.5-vitest-smoke.md) Vitest setup + smoke test
...
- [x] [WP-1.2](docs/work-packages/WP-1.2-validate-content-script.md) `validate-content.mjs` with good/bad fixtures
...
- [x] [WP-1.8](docs/work-packages/WP-1.8-seed-stories.md) Seed batch: ~5 short stories
